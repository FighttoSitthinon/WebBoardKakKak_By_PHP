...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2019 at 04:04 PM
...
CREATE TABLE `comment` (
  `id` int(11) NOT NULL,
  `content` varchar(20148) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'admin', 'ad1234', 'Admin', 'm', 'admin@ad.com', 'a'),
(2, 'member', 'mem1234', 'Member', 'm', 'test@test.com', 'm');
